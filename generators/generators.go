...
// UUIDString converts a 16-byte UUID to its string representation
...
// UUID generates a pseudo-UUID (not a real UUID, not even v4, but looks like one).
...
// ParagraphWithNames works like Paragraph but inserts randomly
// names of the passed set. They can be generated by NameSet().
...
var topLevelDomains = []string{"art", "asia", "at", "au", "biz", "ch", "cn", "com", "de", "dev", "es",
